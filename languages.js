  ...
  window.MELODY_LANGUAGE_PACK = {
    de: {
      ...
      orderForm: {
        ...
        categoryTitle: "Welche Karte möchtest du gestalten?",
        ...
        configurator: {
          ...
          insideLeftSectionTitle: "Innenseite links",
          insideRightSectionTitle: "Innenseite rechts",
          sectionPickerLabel: "Kartenseite auswählen",
          coverSectionHelp: "Vorderseite der Karte",
          insideLeftSectionHelp: "Text oder leer lassen",
          insideRightSectionHelp: "Foto, Text und QR-Code",
          coverActiveTitle: "Cover gestalten",
          insideLeftActiveTitle: "Innenseite links gestalten",
          insideRightActiveTitle: "Innenseite rechts gestalten",
          templateModeLabel: "Gestaltung",
          templateModeTemplate: "Standardkarte",
          templateModeCustom: "Cover personalisieren",
          templateLabel: "Vorlage",
          coverTextLabel: "Cover-Text",
          coverNameLabel: "Name",
          coverExtraLabel: "Kurzer Zusatztext",
          coverPhotoLabel: "Foto für die rechte Innenseite optional",
          yesLabel: "Ja",
          noLabel: "Nein",
          rightPhotoToggleLabel: "Foto einfügen?",
          rightTextToggleLabel: "Text einfügen?",
          rightTextModeLabel: "Text rechts innen",
          positionTop: "Oben",
          ...
          rightTextLabel: "Kurzer Text auf der rechten Innenseite",
          relationshipLabel: "Beziehung zur Person",
          storyLabel: "Was soll im Lied vorkommen?",
          storyHelp: "Schreibe einige Stichpunkte. Je mehr Informationen du gibst, desto persönlicher wird dein Lied.",
          storyPlaceholder: "Beispiele:\n\n• Name der Person\n• Anlass\n• Alter\n• Hobbys\n• lustige Erinnerungen\n• besondere Eigenschaften\n• gemeinsame Erlebnisse\n• Familie\n• Wünsche\n• Insider\n• alles, was im Lied vorkommen soll",
          storyPlaceholders: {
            birthday: "Beispiele:\n\n• Name der Person\n• Alter\n• Hobbys\n• besondere Eigenschaften\n• lustige Erinnerungen",
            apology: "Beispiele:\n\n• Wofür möchtest du dich entschuldigen?\n• Was bedeutet dir die Person?\n• Was tut dir leid?\n• Welche Erinnerung verbindet euch?\n• Was möchtest du sagen?",
            valentine: "Beispiele:\n\n• Name der Person\n• Warum liebst du diese Person?\n• gemeinsame Erinnerungen\n• besondere Momente\n• was macht eure Liebe aus?",
            mothers_day: "Beispiele:\n\n• Name der Mutter\n• wofür bist du dankbar?\n• besondere Erinnerungen\n• was macht sie besonders?\n• was möchtest du ihr sagen?",
            fathers_day: "Beispiele:\n\n• Name des Vaters\n• gemeinsame Erinnerungen\n• wofür bist du dankbar?\n• was macht ihn besonders?\n• was möchtest du ihm sagen?"
          },
          complexDesignLabel: "Besonders aufwendiges Design",
          priceLabel: "Preis",
          priceBaseText: "Preis ab 17 €. Der Endpreis richtet sich nach Wunsch und Aufwand.",
          priceCustomText: "Personalisierung gewählt – Preis wird individuell abgestimmt.",
          qrText: "QR-Code persönliches Lied",
          previewHint: "Schrift, Größe und Design werden von Melody Cards professionell angepasst. Deine Eingaben dienen als Wunsch und Inhalt.",
    ...
    tr: {
      ...
      orderForm: {
        ...
        categoryTitle: "Hangi kartı tasarlamak istiyorsun?",
        ...
        configurator: {
          ...
          coverSectionTitle: "Kapak",
          insideLeftSectionTitle: "Sol iç sayfa",
          insideRightSectionTitle: "Sağ iç sayfa",
          sectionPickerLabel: "Kart sayfasını seç",
          coverSectionHelp: "Kartın ön yüzü",
          insideLeftSectionHelp: "Yazı veya boş bırak",
          insideRightSectionHelp: "Fotoğraf, yazı ve QR kod",
          coverActiveTitle: "Kapağı tasarla",
          insideLeftActiveTitle: "Sol iç sayfayı tasarla",
          insideRightActiveTitle: "Sağ iç sayfayı tasarla",
          templateModeLabel: "Tasarım",
          templateModeTemplate: "Standart kart",
          templateModeCustom: "Kapağı kişiselleştir",
          templateLabel: "Şablon",
          coverTextLabel: "Kapak yazısı",
          coverNameLabel: "İsim",
          coverExtraLabel: "Kısa ek yazı",
          coverPhotoLabel: "Sağ iç sayfa için fotoğraf isteğe bağlı",
          yesLabel: "Evet",
          noLabel: "Hayır",
          rightPhotoToggleLabel: "Fotoğraf eklensin mi?",
          rightTextToggleLabel: "Metin eklensin mi?",
          rightTextModeLabel: "Sağ iç sayfa metni",
          positionTop: "Üst",
          positionMiddle: "Orta",
          positionBottom: "Alt",
          fontElegant: "Zarif",
          ...
          rightTextLabel: "Sağ iç sayfadaki kısa metin",
          relationshipLabel: "Kişiyle ilişkin",
          storyLabel: "Şarkıda neler yer alsın?",
          storyHelp: "Birkaç madde yaz. Ne kadar çok bilgi verirsen şarkın o kadar kişisel olur.",
          storyPlaceholder: "Örnekler:\n\n• Kişinin adı\n• Sebep\n• Yaş\n• Hobiler\n• Komik anılar\n• Özel özellikler\n• Ortak yaşanmışlıklar\n• Aile\n• Dilekler\n• Size özel sözler\n• Şarkıda yer almasını istediğin her şey",
          storyPlaceholders: {
            birthday: "Örnekler:\n\n• Kişinin adı\n• Yaş\n• Hobiler\n• özel özellikler\n• komik anılar",
            apology: "Örnekler:\n\n• Ne için özür dilemek istiyorsun?\n• Bu kişi senin için ne ifade ediyor?\n• Neye üzülüyorsun?\n• Sizi hangi anı bağlıyor?\n• Ne söylemek istiyorsun?",
            valentine: "Örnekler:\n\n• Kişinin adı\n• Bu kişiyi neden seviyorsun?\n• ortak anılar\n• özel anlar\n• aşkınızı özel yapan şey",
            mothers_day: "Örnekler:\n\n• Annenin adı\n• ne için minnettarsın?\n• özel anılar\n• onu özel yapan şey\n• ona ne söylemek istiyorsun?",
            fathers_day: "Örnekler:\n\n• Babanın adı\n• ortak anılar\n• ne için minnettarsın?\n• onu özel yapan şey\n• ona ne söylemek istiyorsun?"
          },
          complexDesignLabel: "Özellikle detaylı tasarım",
          priceLabel: "Fiyat",
          priceBaseText: "Fiyat 17 €'dan başlar. Son fiyat istek ve emeğe göre belirlenir.",
          priceCustomText: "Kişiselleştirme seçildi – fiyat isteğe göre belirlenir.",
          qrText: "Kişisel şarkı QR kodu",
          previewHint: "Yazı tipi, boyut ve tasarım Melody Cards tarafından profesyonelce ayarlanır. Girdilerin istek ve içerik olarak kullanılır.",
