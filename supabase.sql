...
alter table public.premium_orders add column if not exists card_type_id text;
alter table public.premium_orders add column if not exists occasion_label text;
alter table public.premium_orders add column if not exists cover_mode_id text;
alter table public.premium_orders add column if not exists cover_image_enabled boolean default false;
alter table public.premium_orders add column if not exists cover_image_url text;
alter table public.premium_orders add column if not exists inside_left_mode_id text;
alter table public.premium_orders add column if not exists inside_left_image_enabled boolean default false;
alter table public.premium_orders add column if not exists inside_left_image_url text;
alter table public.premium_orders add column if not exists inside_right_image_enabled boolean default false;
alter table public.premium_orders add column if not exists inside_right_image_url text;
alter table public.premium_orders add column if not exists inside_right_mode_id text;
alter table public.premium_orders add column if not exists love_story text;
alter table public.premium_orders add column if not exists romantic_style text;
alter table public.premium_orders add column if not exists memory text;
alter table public.premium_orders add column if not exists qr_position text;
...
alter table public.orders add column if not exists card_type_id text;
alter table public.orders add column if not exists occasion_label text;
alter table public.orders add column if not exists cover_mode_id text;
alter table public.orders add column if not exists cover_image_enabled boolean default false;
alter table public.orders add column if not exists cover_image_url text;
alter table public.orders add column if not exists inside_left_mode_id text;
alter table public.orders add column if not exists inside_left_image_enabled boolean default false;
alter table public.orders add column if not exists inside_left_image_url text;
alter table public.orders add column if not exists inside_right_image_enabled boolean default false;
alter table public.orders add column if not exists inside_right_image_url text;
alter table public.orders add column if not exists inside_right_mode_id text;
alter table public.orders add column if not exists love_story text;
alter table public.orders add column if not exists romantic_style text;
alter table public.orders add column if not exists memory text;
alter table public.orders add column if not exists qr_position text;
